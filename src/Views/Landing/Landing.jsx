          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 ">
            <div className="mt-12 lg:mt-0">
              ...
              <h1 className="mt-0 mb-12 text-5xl tracking-tight md:text-4xl xl:text-5xl text-white">
                ¡Crea tu Cuenta!: Fácil, Rápido y Seguro. <br />
              </h1>
            ...
            <div className="mb-12 lg:mb-0">
              <img
                src="https://us.123rf.com/450wm/virtosmedia/virtosmedia2301/virtosmedia230102250/197223001-piedras-zen-en-la-playa-al-atardecer-concepto-de-armon%C3%ADa-y-equilibrio.jpg"
